...
<input   type="hidden"      id="kStaffId"   name="kStaffId" value="${staffVo.kStaffId}">
			<div class="content_up">
				...
				<div class="tbl_top">
					<ul class="tbl_top_left" >
					    ...
					    <li>
						<input type="text" class='inp_color'  style="width:120px; text-align:center;" name="eTopStartDate" id="eTopStartDate" value="${staffVo.eTopStartDate}"  readonly/>
	          			 	~<input type="text" class='inp_color'  style="width:120px; text-align:center;" name="eTopEndDate" id="eTopEndDate" value="${staffVo.eTopEndDate}"  readonly/>
	     				</li>
			           	<li>	
			           		<a style="cursor: pointer;" onclick="eNowPage()">검색</a>        	     			
						</li>	
					</ul>
				</div>
			...
			<div class="lf_tbl_list"  style="overflow-x:scroll;">
