...
$(document).ready(function(){	
	...
	var eFileID = "${mesBlueprintVO.eFileID}";
	var eFileName = "${mesBlueprintVO.eFileName}";
	var eFileExt = "${mesBlueprintVO.eFileExt}";
	if (eGubunPage == "N") {
...
<form id="frm" name="frm" method="post"  enctype="multipart/form-data"  action="/mes/blueprint/popup/kw_sr_File_insert.do">
	...
	<div class="popup_content">
			  ...
			  <tbody>
					<tr>
		      			<td>
		      				...
		      				<input type="hidden" name='eFileName' id='eFileName' value=''>  
		...
		<div class="tbl_btn_right">
			<ul>
				<li>
					<a style="cursor: pointer;" onclick="mesFileInsert();">
								등록
						</a>
				</li>
				<li>		
