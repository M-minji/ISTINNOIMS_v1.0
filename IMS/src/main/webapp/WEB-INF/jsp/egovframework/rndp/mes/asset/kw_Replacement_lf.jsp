...
$(function(){
	datepickerSet("topStartDate","topEndDate");
	  ...
	  $('table[role="grid"].gridjs-table th:nth-child(9)').css('width', '160px'); 
	  ...
	  $('table[role="grid"].gridjs-table th:nth-child(10)').css('width', '240px'); 
	  ...
	  $('table[role="grid"].gridjs-table th:nth-child(11)').css('width', '240px'); 
					...
					<tr onclick="eReplacementView(<c:out value='${list.eReplacedKey}'/>);">
						...
						<td onclick="event.cancelBubble = true;">
							...
							<c:if test="${list.sSignStatus eq '등록'}">
								<c:if test="${list.kStaffKey eq staffVO.kStaffKey}"><a style="cursor: pointer;" class="mes_btn" onclick="startApproval('${list.eReplacedKey}','Y');">승인요청</a></c:if>
							...
							<c:if test="${list.sSignStatus eq '승인요청'}">
								<c:if test="${list.kStaffKey eq staffVO.kStaffKey && list.sSignProgress eq '0'}">
									<a style="cursor: pointer;" class="mes_btn" onclick="startApproval('${list.eReplacedKey}','N');">요청취소</a>
								</c:if>
