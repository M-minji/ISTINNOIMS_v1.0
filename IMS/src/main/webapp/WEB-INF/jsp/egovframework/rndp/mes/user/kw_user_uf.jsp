			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3">
						...
						변경 비밀번호 : <input type="password" id="chPassword" name="chPassword" value="" style="width:300px;" maxlength="20" onblur="passwordResultCheck();" />
						...
						<a class="list_btn" onclick="updatePwd_go()"> 
              				변경하기
              			</a>
						<a class="list_btn" onclick="updateNewPwd_go()"> 
              				초기화
              			</a>
				...
				<tr>
					<th>생년월일</th>
					<td>
						<input type="text" name="mesUserBirthday" maxLength="8" onkeypress="onlyNumber();" value="${mesUserInfo.mesUserBirthday}"/> (Ex:19220125) 
						<input type="radio" name="mesUserBirthdayFlag" value="T" <c:if test="${mesUserInfo.mesUserBirthdayFlag eq 'T'}">checked</c:if>><span>양력 </span>
						<input type="radio" name="mesUserBirthdayFlag" value="F" value="T" <c:if test="${mesUserInfo.mesUserBirthdayFlag eq 'F'}">checked</c:if>><span>음력 </span>
					</td>
					<th>E-Mail</th>
				...
				<tr>
            		...
            		<td colspan="3">
						...
						<a class="list_btn" onclick="sample6_execDaumPostcode()"> 
              				우편번호 찾기
              			</a><br>
...
<!-- 	style="display: none;" -->
		<table>
			<tbody>
				<tr>
					<th style="width: 7%;">시스템 관리자 권한</th>
					<td colspan="3" >
						<label class="switch"  >
	...
	<div class="tbl_btn_right">
		<ul> <li>비밀번호 변경시 "변경하기"버튼으로 반영하세요!</li>
			...
			<li>
				<a href="javascript:cancle();">목록</a>
				<!-- <a href="/mes/kw_member.lf.do">목록</a> -->
			</li>
		</ul>
	</div>
</form>