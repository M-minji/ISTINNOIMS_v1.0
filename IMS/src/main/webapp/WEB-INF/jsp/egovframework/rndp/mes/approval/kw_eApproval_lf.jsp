	...
	<div class="content_up">	
		...
		<div class="tbl_top"> 
			<ul class="tbl_top_left" >  
				...
				<li>
					 <span>요청일자</span>
		       		<input type="text" name="eTopStartDate" id="eTopStartDate" value="${mesApprovalVO.eTopStartDate}"  style="width:100px;text-align: center;" readonly  class="inp_color"/>
		           	~ <input type="text" name="eTopEndDate" id="eTopEndDate" value="${mesApprovalVO.eTopEndDate}"  style="width:100px;text-align: center;" readonly class="inp_color" />
		     	</li>
				<li>	
