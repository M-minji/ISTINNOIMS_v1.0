...
<form name="writeForm" id="writeForm" method="post" enctype="multipart/form-data">
	...
	<input type="hidden" name="sSignStatus" id="sSignStatus" value="${mesAssetVO.sSignStatus}" />
	<div class="content">	
		<div class="content_tit">
			<h2>보유자산 반입 정보 수정페이지</h2>
		</div>
	</div>
				 		 ...
				 		 <tr>
						 	<td>-
								 	...
								 	<td>${list.eAssetType }
								 		...
								 		<input type='hidden' id='sSignStatus1_${i.index}' name='sSignStatus1' value='${list.sSignStatus}'/>
								 	</td>
