...
<form name="writeForm" id="writeForm" method="post" enctype="multipart/form-data">
		...
		<table>
			<tbody>
				...
				<tr>
					<th>*반출자</th>
					<td>
						<input type="text" name="eEntryStaff" id="eEntryStaff" style="width:95%; text-align:left;"  value="${assetInfo.eEntryStaff }"  class="inp_color"  readonly="readonly" onclick="selectWorkerPop('R','eEntryStaff')"/>
					</td>
					<th>반출자 소속</th>
					<td><span id="eEntryStaffOrgTxt">${assetInfo.eEntryStaffOrg }</span>
						<input type="hidden" name="eEntryStaffOrg" id="eEntryStaffOrg" style="width:95%; text-align:left;" value="${assetInfo.eEntryStaffOrg }" />
					</td>
				</tr>
				<tr>
					<th>요청사유</th>
					...
					<th>반출처</th>
					<td colspan="1"> 
						<input type="text" name="eExportLocation" id="eExportLocation" style="width:95%; text-align:left;" maxLength="50" value="${assetInfo.eExportLocation }"/>
					</td>
				</tr>
			</tbody>
		</table>
				 		 ...
				 		 <tr>
						 	<td><a class='del' onclick="delRow(this);">X</a>
								 	...
								 	<td>${list.eAssetType }
								 		...
								 		<input type='hidden' id='eEntryStaffOrg_${i.index}' name='eEntryStaffOrg1' value='${list.eEntryStaffOrg}'/>
	...
	<div class="tbl_btn_right">
		<ul>
			...
			<li>
				<a style="cursor: pointer;" onclick="cancle();">목록</a>
			</li>
		</ul>
	</div>
</form>
