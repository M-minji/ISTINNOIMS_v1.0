					...
					<div class="content_tit">
						<h2>직원정보수정
							<c:if test="${vo.kStaffId eq 'rndp' or vo.kStaffId eq 'innost'}">
								<a class="mes_btn"  onclick="databaseDelete()">DB TRUNCATE</a>
							</c:if>
						</h2>
					</div>
				</div>	
	...
	<!-- 								<a onclick="javascript:checkStaffId()" >중복체크</a>-->
							...
							<tr>
								...
								<td class="myinfo_font">
									...
									<p><span>변경 비밀번호 : </span><input type="password" class="myinfo_input"  name="chPassword" id="chPassword" value="" /></p>
									<p><span>비밀번호 확인 : </span><input type="password" class="myinfo_input"  name="chPassword2" id="chPassword2" value="" /><a name="btn_01" class="mes_btn" onclick="updatePwd_go();">비밀번호 변경</a></p>
								</td>
							</tr>
							<!-- <tr>
								<th>비밀번호</th>
							...
							<TR>
								<TH>생년월일</th>
								<TD><input type="text" name="kStaffBirthday" value="<c:out value='${vo.kStaffBirthday}'/>" maxLength="8"> 
									<input type="radio" name="kStaffBirthdayFlag" value="T" <c:if test="${ vo.kStaffBirthdayFlag eq 'T' }" > checked</c:if>><span>양력 </span>
									<input type="radio" name="kStaffBirthdayFlag" value="F" <c:if test="${ vo.kStaffBirthdayFlag eq 'F' }" > checked</c:if>><span>음력</span>
								</td>
							</tr>
							<TR>
								<TH>이 메 일</th>
							...
							<tr>
			            		...
			            		<td>
									...
									<a onclick="sample6_execDaumPostcode()" class="mes_btn"> 
			              				우편번호찾기
			              			</a><br>
			...
			<div class="tbl_btn_right">
					<ul>
						 <%-- <li>
							<a href="javascript:windowPopup1(<c:out value='${vo.kStaffKey}' />);">
								사진등록
							</a>
						</li>
						<li>
							<a href="javascript:windowPopup2(<c:out value='${vo.kStaffKey}' />);">
								사인등록
							</a>
						</li> --%>
						<li>
						...
						<li>
							<a href="/mes/myPage/kw_myPage_lf.do">취소</a>
						</li>
					</ul>
				</div>
