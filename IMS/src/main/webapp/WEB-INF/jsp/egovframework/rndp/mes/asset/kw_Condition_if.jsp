		...
		<table>
			<tbody>
				...
				<tr>
					<th>*반출자</th>
					<td>
						<input type="text" name="eEntryStaff" id="eEntryStaff" style="width:95%; text-align:left;" class="inp_color"  readonly="readonly" onclick="selectWorkerPop('R','eEntryStaff')"/>
					</td>
					<th>반출자 소속</th>
					<td><span id="eEntryStaffOrgTxt"></span>
						<input type="hidden" name="eEntryStaffOrg" id="eEntryStaffOrg" style="width:95%; text-align:left;" maxLength="30" value=""/>
					</td>
				</tr>
				<tr>
					<th>반출사유</th>
