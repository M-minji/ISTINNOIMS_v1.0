...
$(document).ready(function(){	
	...
	var eFileID = "${mesIssueVO.eFileID}";
	var eFileName = "${mesIssueVO.eFileName}";
	var eFileExt = "${mesIssueVO.eFileExt}";
	if (eGubunPage == "N") {
...
<form id="frm" name="frm" method="post"  enctype="multipart/form-data"  action="/mes/issue/popup/kw_File_insert.do">
