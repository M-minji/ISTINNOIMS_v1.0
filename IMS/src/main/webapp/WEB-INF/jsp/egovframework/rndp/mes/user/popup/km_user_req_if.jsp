...
<form name="writeform" method="post" action="/popup/checmesUserId.do">
	<!-- 무조건 재직 -->
			...
			<table>
				<tbody>
					...
					<tr>
						...
						<td>
							<p>
								<input type="text" id="mesUserId" name="mesUserId" maxLength="20" onkeydown="againChecmesUserId()" />
								<a class="mes_btn" onclick="javascript:checmesUserId()">확인</a>
							</p>
						</td>
					</tr>
					<tr>
						<th scope="row">*이 름</th>
						<td>
							<input type="text" name="mesUserName" maxLength="50" />
						</td>
					</tr>
					<tr>
...
<!-- 							<input type="password" name="mesUserPassword1" maxLength="20" /> -->
							<input type="password" id="mesUserPassword1" name="mesUserPassword1" maxLength="20" onblur="passwordResultCheck();" />
					...
					<tr>
						...
						<td>
							<input type="password" id="mesUserPassword2" name="mesUserPassword2" maxLength="20" onblur="samePassword();" />
					...
					<tr>
						...
						<td><input type="text" name="mesUserBirthday" maxLength="8" onkeypress="onlyNumber();"
								style="ime-mode: disabled; width: 150px;" /> <span>(Ex:19220125) </span> 
							<input type="radio" name="mesUserBirthdayFlag" value="T" checked><span>양력</span>
							<input type="radio" name="mesUserBirthdayFlag" value="F"><span>음력</span></td>
					</tr>
					<tr>
						<th scope="row">이 메 일</th>
						<td><input type="text" name="mesUserEmail" maxLength="100" /></td>
					</tr>
	          		<tr>
	            		<th scope="row">주소</th>
	            		<td>
	            			<div class="tbl_group">
	            				<ul>
	            					<li>
										<input type="text" name="mesUserPost1" id="mesUserPost1" placeholder="우편번호" maxlength="5" >
										<a class="mes_btn" onclick="sample6_execDaumPostcode()"> 
				              				우편번호찾기
				              			</a>
									</li>
									<li>	
										<input type="text" name="mesUserAddress1" id="mesUserAddress1" placeholder="주소" style="width:300px;" readonly />
										<input type="text" name="mesUserAddress2" id="mesUserAddress2" placeholder="상세주소" style="width:250px;" maxlength="100" />
	              					</li>
	              				</ul>
	              			</div>
	              		</td>
