...
function fn_guestList(pageNo) {
	...
	document.frm.action = "/mes/asset/kw_asset_box_inspection.do";
	document.frm.submit();
}
...
<form id="frm" name="frm" method="post" action="/mes/asset/kw_asset_box_inspection.do">
	...
	<div class="popup_content">		
		<div id="itemCateZone" class="tbl_top">
			<ul class="tbl_top_left">
				...
				<li>
					<span>자산유형</span>
						<select id='searchTypeSet6' name='searchTypeSet6'  >
				...
				<li>
					<span>모델명</span>
					<input type="text" id="searchTypeSet5" name="searchTypeSet5" style="width:150px;" class="searchWord" value="${mesAssetVO.searchTypeSet5}" />
				</li>
				<li>
					...
					<c:forEach var="list" items="${assetList}" varStatus="i">
						<tr style="cursor: pointer;" onclick="rowCheck('${list.aAssetKey}')" >
							<td onclick="event.cancelBubble = true;">
								...
								<input type="checkbox" id="check_${list.aAssetKey}" name="check" class="rowCheckbox">
<!-- 							</td> -->
<!-- 							<td> -->
