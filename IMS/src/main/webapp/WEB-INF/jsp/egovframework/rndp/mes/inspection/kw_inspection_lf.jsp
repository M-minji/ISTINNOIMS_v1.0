...
$(document).ready(function() {
	 datepickerSet("eTopStartDate","eTopEndDate");
	  ...
	  $('table[role="grid"].gridjs-table th:nth-child(3)').css('width', '80px'); // 점검구분
	  $('table[role="grid"].gridjs-table th:nth-child(4)').css('width', '80px'); // 점검주기
	  $('table[role="grid"].gridjs-table th:nth-child(5)').css('width', '80px'); // 점검일자
	  $('table[role="grid"].gridjs-table th:nth-child(6)').css('width', '70px'); // 점검자
	  $('table[role="grid"].gridjs-table th:nth-child(7)').css('width', '400px'); // 특이사항 
	  $('table[role="grid"].gridjs-table th:nth-child(8)').css('width', '280px'); // 상테
	  tdBlock(7);
