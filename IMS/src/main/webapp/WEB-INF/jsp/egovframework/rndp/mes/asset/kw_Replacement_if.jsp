...
<script type="text/javascript">
	...
	function insert_go(){
		...
		if(confirm("저장하시겠습니까?")){
			...
			document.writeForm.action = "/mes/asset/kw_eReplacement_i.do";
		...
		<table>
			<tbody>
				...
				<tr>
					<th>*교체일자</th>
					<td colspan="3">
						<input type="text" name="eReplacementDate" id="eReplacementDate" style="width:120px; text-align:center;" class="inp_color"   value=""  readonly="readonly"/>
					</td>
				</tr>
				<tr>
					<th>*교체자</th>
					<td>
						<input type="text" name="eReplacedBy" id="eReplacedBy" style="width:95%; text-align:left;" maxLength="30" value=""/>
					</td>
					<th>교체자 소속</th>
					<td>
						<input type="text" name="eReplacementRequester" id="eReplacementRequester" style="width:95%; text-align:left;" maxLength="30" value=""/>
					</td>
				</tr>
				<tr>
					<th>교체 정보</th>
					<td colspan="1">
						<input type="text" name="ePartReplacementReason" id="ePartReplacementReason" style="width:95%; text-align:left;" maxLength="50" value=""/>
					</td>
					<th>부품유형</th>
					<td colspan="1">
						<input type="text" name="ePartReplacementItem" id="ePartReplacementItem" style="width:95%; text-align:left;" maxLength="50" value=""/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td id="td_editor" colspan="4" align="center" scope="row"> 
						<textarea id="eReqContent" name="eReqContent" cols="100%" rows="10" style="font-size: 20px; width: 100%; height: 300px; resize: none;" ></textarea>
					</td>
				</tr>
			</tbody>
		</table>
