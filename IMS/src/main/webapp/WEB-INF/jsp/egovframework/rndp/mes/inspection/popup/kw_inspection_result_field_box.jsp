...
<form id="frm" name="frm" method="post" action="/mes/inspection/kw_inspection_field_box.do">
	...
	<div class="popup_content">		
		<div id="itemCateZone" class="tbl_top">
			<ul class="tbl_top_left">
				...
				<li>
					<span>이름</span>
					<input type="text" id="eSearchTypeSet1" name="eSearchTypeSet1" style="width:150px;" class="searchWord" value="${mesInspectionVO.eSearchTypeSet1}" />
				</li>
				<li>
					<span>필드</span>
					<input type="text" id="eSearchTypeSet2" name="eSearchTypeSet2" style="width:150px;" class="searchWord" value="${mesInspectionVO.eSearchTypeSet2}" />
				</li>
				<li>
