		...
		<table>
			<tbody>
				<tr>
					...
					<select id='eAssetType' name='eAssetType'  onchange="updateAssetTypeName()" style="width: 120px;" >
						...
						<c:forEach var='list' items='${gubun36List}'>
							<option value='${list.sGubunKey}' data-value2='${list.sGubunName}'  data-value3='${list.sGubunEtc}'>${list.sGubunName}</option>						
						</c:forEach>
					</select>
					</td>
				...
				<tr>
					...
					<th>자산상태</th>
					<td>
					 	<input type="hidden" id="eAssetStatusName" name="eAssetStatusName" value="" /><!-- 					 	style="pointer-events: none;"  class="inp_color"  -->
						<select id='eAssetStatus' name='eAssetStatus'  onchange="eAssetStatusCheck()" style="width: 120px;" >
          		...
          		<tr>
          			<th>도입원가(원)</th>
            		<td>
						<input type="text" name="eAssetCost" id="eAssetCost" style="width:95%; text-align:right; padding-right: 5px;" maxLength="10" onblur="setComma(this.id)" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" value=""/>
            		</td>
            			<th>도입일</th>
            		<td>
						<input type="text" id="eAssetDate" name="eAssetDate" style="width:150px; text-align:center;" class="inp_color" readonly onchange="eLifCheck()"  />
            		</td>
          		</tr>		
        		<tr>
            		<th>장비구분</th>
        		...
        		<tr>
          		...
          		<tr>          		
					<th>EoS</th>
            		<td>
            			<input type="text" name="eEosDate" id="eEosDate" style="width:150px; text-align:center;" class="inp_color" onchange="eDate('eEosDate')"  readonly />
            			<span id="eEosDateTxt"></span>
            			*미입력시 2999-01-01 반영
            		</td>
            		<th>EoL</th>
            		<td>
            			<input type="text" name="eEolDate" id="eEolDate" style="width:150px; text-align:center;" class="inp_color" onchange="eDate('eEolDate')"  readonly  />
				...
				<tr>          		
					<th>내구연수</th>
					<td colspan="1">
            			<input type="text" name="eLifespan" id="eLifespan" style="width:50px; text-align:right; padding-right: 5px;" maxLength="2" value="" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"  onchange="eLifCheck()"  />:(연 단위)
...
<!-- 					        </select> -->
					...
					<th>비고</th>
					<td colspan="1">
						<textarea id="eAssetEtc" name="eAssetEtc" style="resize: none; width:95%;" maxLength="100"></textarea>
					</td>
          		</tr>		
        		<tr> 
            		<th>장비사진<a class="mes_btn" onclick="addFile();">추가</a></th>
            		<td colspan="3">
						...
						<input type="hidden" id="eAssetImageExt"  name="eAssetImageExt">
						 <iframe id="pdfViewer" width="250px;" height="250px;" frameborder="0"></iframe>
               			 <img id="eImgViewer"  style="display: none;width: 250px;height: 250px;"  src="" >
					</td>
				</tr>			
			</tbody>
		</table>
